        ...
        <div class = "col-4 offset-4"><!-- start Suggestions message_box -->
            ...
            <div class = "message_box">
                <form enctype="multipart/form-data" action="../php/add_person.php" method = "post" class="feed_side_space row">
                    <input class = "form-control suggestion_item input_length" name = "fName" type = "text" placeholder="Fist Name">
                    <input class = "form-control suggestion_item input_length" name = "lName" type = "text" placeholder="Last Name">
                    <input class = "form-control suggestion_item input_length" name = "email"type = "email" placeholder="email@eagle.clarion.edu">
